...
enum __attribute__((packed)) Species
{
    ...
    SPECIES_PETAMOLE = 1573,
    SPECIES_FLAMBEAR = 1574,
    SPECIES_VOLBEAR = 1575,
    SPECIES_DYNABEAR = 1576,
    SPECIES_CRUIZE = 1577,
    SPECIES_AQUALLO = 1578,
    SPECIES_AQUARIUS = 1579,
    SPECIES_TANGTRIP = 1580,
    SPECIES_GELANIA = 1581,
    SPECIES_TRIPSTAR = 1582,
    SPECIES_TUHEAD = 1583,
    SPECIES_KOTORA = 1584,
    SPECIES_RAITORA = 1585,
    SPECIES_PETICORN = 1586,
    SPECIES_BOMSHEAL = 1587,
    SPECIES_BELMITT = 1588,
    SPECIES_GUPGOLD = 1589,
    SPECIES_CORASUN = 1590,
    SPECIES_ANCHORAGE = 1591,
    SPECIES_GROTESS = 1592,
    SPECIES_TRITALES = 1593,
    SPECIES_TWINZ = 1594,
    SPECIES_TURBAN = 1595,
    SPECIES_GRIMBY = 1596,
    SPECIES_PARAMITE = 1597,
    SPECIES_METTO = 1598,
    SPECIES_PRAXE = 1599,
    SPECIES_RINRING = 1600,
    SPECIES_BELLRUN = 1601,
    SPECIES_NUMBPUFF = 1602,
    SPECIES_NYANYA = 1603,
    SPECIES_MADAME = 1604,
    SPECIES_KURSTRAW = 1605,
    SPECIES_PANGSHI = 1606,
    SPECIES_PUDDIPUP = 1607,
    SPECIES_RAYLEEP = 1608,
    SPECIES_BALLERINE = 1609,
    SPECIES_ELEBABE = 1610,
    SPECIES_CHIX = 1611,
    SPECIES_WOLFAN = 1612,
    SPECIES_WARWOLF = 1613,
    SPECIES_LICKILORD = 1614,
